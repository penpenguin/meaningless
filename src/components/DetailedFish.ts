...
import {
  ...
  LOCOMOTION_PROFILES,
  createFishVariants as createFishVariantDefinitions,
  resolveDefaultFishCount,
  resolveHeroAccentDepthMultiplier as resolveHeroAccentDepthMultiplierRule,
  resolveHeroAccentScaleMultiplier as resolveHeroAccentScaleMultiplierRule,
  resolveHeroPlacements as resolveHeroPlacementRules,
  resolveHeroPriorityMultiplier as resolveHeroPriorityMultiplierRule,
...
export class DetailedFishSystem {
  ...
  private resolveDefaultFishCount(isMobile: boolean): number {
    return resolveDefaultFishCount(this.layoutStyle, isMobile)
  }
